...
public class PersonEmailTest {
    ...
    public void validEmail() {
        ...
        Assertions.assertEquals(PersonEmail.of(email).toString().length(), email.length());
    }
    ...
    public void invalidEmail() {
        ...
        var exception = Assertions.assertThrows(IllegalArgumentException.class, () -> {
            PersonEmail.of(email);
        });
        Assertions.assertEquals(exception.getMessage(), "Invalid email");
    }
